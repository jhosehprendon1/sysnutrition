...
const Bienvenida = () => {
  ...
  return (
    <div className="container-center">
      ...
      <iframe className="reto-video" src="https://www.youtube.com/embed/Inq3XMSjS_s?rel=0" title="Reto Antiinflamatorio Bienvenida" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div style={{textAlign: 'center', color: '#283d54'}}>
      ...
      <div className="reto-button-control">
        ...
        <button type="submit" style={{padding: "10px 20px", marginRight: "10px"}} className="primary-button full">Acceso al grupo de Whatsapp</button>
